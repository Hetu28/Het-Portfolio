  ...
  return (
    <section id="filmography" className="relative z-10 pt-20 md:pt-28 pb-8 md:pb-12">
      <div className="max-w-[1400px] mx-auto px-5 md:px-8">
        ...
        {/* Heading */}
        <h2 className="text-[44px] md:text-[76px] lg:text-[96px] leading-[0.98] tracking-[-0.03em] font-black mb-16">
          Pieces of{" "}
            ...
            >
              ...
              <div className="lg:col-span-4">
                <div className="sticky top-32">
                  <div className="text-[11px] sm:text-[12px] md:text-[13px] tracking-[0.32em] text-white/50 mb-2 font-mono">
                    {String(groupIdx + 1).padStart(2, "0")}
                  </div>
                  <div className="text-[15px] sm:text-[16px] md:text-[17px] tracking-[0.25em] font-bold uppercase" style={{ color: "var(--accent)" }}>
                    {group.role}
                  </div>
                  {group.subtitle && (
                    <div className="mt-3.5 sm:mt-4 text-white/60 text-[15px] sm:text-[16px] max-w-sm leading-[1.6]">
                      {group.subtitle}
                    </div>
                  )}
                </div>
