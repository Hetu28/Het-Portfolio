  ...
  return (
    <section id="experience" className="relative z-10 pt-4 md:pt-6 pb-20 md:pb-28 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-5 md:px-8">
        ...
        {/* Heading & Subheading */}
        <div className="flex flex-col lg:flex-row lg:items-stretch justify-between gap-6 lg:gap-10 mb-10">
          <div className="max-w-xl">
            ...
            <p className="mt-2.5 text-white/55 text-[13.5px] sm:text-[14.5px] leading-relaxed">
              No role on a film set is too small. Whether I'm guiding the camera, keeping the schedule locked as an AD, or running production logistics, here is where I’ve put the craft to work.
            </p>
          </div>

          {/* Filter Pills - Vertically Centered & Enhanced Box Sizing */}
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-2.5 lg:justify-end">
              {["All", "Cinematography & Camera", "Direction & AD", "Production Management", "Sound & Technical"].map((cat) => (
                <button
                  ...
                  className={`px-4 sm:px-4.5 py-2 sm:py-2.5 rounded-full text-xs sm:text-[13px] font-semibold tracking-wide transition-all duration-300 ${
                    selectedRole === cat
                      ? "bg-white text-black shadow-lg scale-[1.03]"
                      : "bg-white/[0.05] text-white/65 hover:text-white hover:bg-white/[0.1] border border-white/[0.08]"
                  }`}
                >
        ...
        <div className="relative">
          ...
          {/* Bottom Legend */}
          <div className="mt-5 pt-3.5 border-t border-white/[0.08] flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-6 text-[11px] text-white/60 font-mono">
        ...
        {/* =========================================================================
            ...
            ========================================================================= */}
        <div className="mt-8 sm:mt-10 pt-28 sm:pt-36 md:pt-44 lg:pt-48 border-t border-white/[0.08]">
          {/* Eyebrow */}
          <div className="flex items-center gap-3 mb-4">
            <span className="w-6 h-px bg-white/25" />
            <span className="text-[10px] tracking-[0.32em] text-white/50 font-medium uppercase font-mono">
