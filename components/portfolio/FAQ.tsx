      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            {/* Giant Dynamic Gradient Title */}
            <h2 className="text-6xl sm:text-7xl md:text-8xl lg:text-[92px] font-black tracking-tight leading-none uppercase select-none mb-4 inline-block gradient-text">
              FAQ.
            </h2>
            ...
            <p className="text-white/60 text-[14.5px] sm:text-[15.5px] leading-relaxed mb-8 max-w-lg">
              Got questions about pre-production treatments, camera gear, travel, or edit revisions? I’ve laid out the essentials so you know exactly what it feels like to work with me.
            </p>
            ...
            <div className="rounded-2xl p-6 bg-[#0c0c0f]/90 border border-white/[0.08] relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-xs font-mono text-[var(--accent)] font-semibold uppercase tracking-wider mb-2">
                  Have a unique project?
                </div>
                <p className="text-white/70 text-xs sm:text-sm leading-relaxed mb-4">
                  Need something custom that doesn’t fit into a standard box? Drop me a message and let’s make it happen.
                </p>
                <a
                  href="/contact"
