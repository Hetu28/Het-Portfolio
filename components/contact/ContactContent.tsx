...
export default function ContactContent() {
  ...
  return (
    <div className="relative z-10 w-full overflow-hidden pt-18 sm:pt-24 md:pt-36 pb-16 bg-transparent">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-5 md:px-8 mb-12 sm:mb-16">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 pb-8 border-b border-white/[0.08]">
          <div>
            ...
            <h1
              className="font-black uppercase tracking-tight text-white select-none"
              style={{ fontSize: "clamp(38px, 10vw, 120px)", lineHeight: 0.9 }}
            >
              Connect.
            </h1>
      ...
      {/* =========================================================================
          4. DUAL SLIDING TEXT MARQUEE (After SEND AN INQUIRY & Before Name / Footer)
          ========================================================================= */}
      <div className="relative mt-8 sm:mt-12 py-12 sm:py-16 overflow-hidden border-y border-white/[0.08] select-none pointer-events-none">
        <div className="flex flex-col justify-center items-center overflow-hidden opacity-30">
          <div className="marquee-fast-left">
            <div className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black uppercase text-white tracking-tight whitespace-nowrap px-4">
              {aboutData.ctaMarquee.line1.join(" • ")} •{" "}
              {aboutData.ctaMarquee.line1.join(" • ")} •
            </div>
          </div>
          <div className="marquee-fast-right mt-3 sm:mt-4">
            <div
              className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight whitespace-nowrap px-4"
              style={{ color: "var(--accent)" }}
            >
